"""
Django settings for hithi_dev_132587 project.
...
ROOT_URLCONF = 'hithi_dev_132587.urls'
...
WSGI_APPLICATION = 'hithi_dev_132587.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hithi_dev_132587 API",
    "DESCRIPTION": "API documentation for hithi_dev_132587 App",
    "VERSION": "v1",
}
